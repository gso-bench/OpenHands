...
# L = 50, k = 8, temp = N/A
# ./evaluation/benchmarks/pyperf/scripts/run_infer.sh --model-config llm.eval_o4-mini --commit-hash HEAD --agent CodeActAgent --num-workers 60 --n-runs 8 --max-iter 50
# docker container prune -f

# L = 100, k = 4, temp = N/A
# ./evaluation/benchmarks/pyperf/scripts/run_infer.sh --model-config llm.eval_o4-mini --commit-hash HEAD --agent CodeActAgent --num-workers 60 --n-runs 4 --max-iter 100
# docker container prune -f

# L = 200, k = 2, temp = N/A
# ./evaluation/benchmarks/pyperf/scripts/run_infer.sh --model-config llm.eval_o4-mini --commit-hash HEAD --agent CodeActAgent --num-workers 60 --n-runs 2 --max-iter 200
# docker container prune -f
