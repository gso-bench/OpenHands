##### TODO: Adapt this from swebench to pyperf report processing!
...
if os.path.exists(swebench_official_report_json):
    ...
    print(f'No report file found: {swebench_official_report_json} do not exist.')
    exit()
